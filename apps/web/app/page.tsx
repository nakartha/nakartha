...
function App() {
  ...
  // Add class to body when sheet is open to prevent scrolling
  React.useEffect(() => {
    if (isOpen) {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="md:hidden">
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent 
                  side="right" 
                  className="fixed top-0 right-0 h-full w-[300px] z-50 shadow-xl border-l border-gray-200"
                >
      ...
      <div className={`relative ${isOpen ? 'fixed inset-0' : ''}`}>
        {/* Hero Section */}
